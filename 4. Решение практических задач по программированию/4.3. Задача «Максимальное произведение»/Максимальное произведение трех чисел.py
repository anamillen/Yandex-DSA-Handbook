...
Вычислите max(ai * aj * ak) (i!=j!=k)

Обратите внимание, что i, j и k должны быть разными, хотя в каких-то случаях можно наблюдать, что ai = aj = ak​.
"""

def max_product_of_3(n,li):
